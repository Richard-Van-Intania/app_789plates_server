...
FROM latest_price
    ...
    INNER JOIN public.special_front ON special_front.special_front_id = plates.special_front_id
    INNER JOIN public.province ON province.province_id = plates.province_id
